...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-7996315783263946~2769939318");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            ...
            case R.id.moreApps:
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=pub:Shashank Chandak")));
                } catch (android.content.ActivityNotFoundException anfe) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/developer?id=Shashank Chandak")));
                }
                break;
